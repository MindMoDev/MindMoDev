...
function animateText(element) {
  ...
  const interval = setInterval(() => {
    ...
    if (index < charElements.length) {
      charElements[index].classList.remove('hidden');
      index++;
    } else {
      ...
      }, 1000); // Change this value to adjust the duration before text fades out
    }
  }, 100); // Change this value to adjust the speed of animation
}
